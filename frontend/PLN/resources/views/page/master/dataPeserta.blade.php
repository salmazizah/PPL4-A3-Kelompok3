...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('dataPeserta.add') }}" class="btn btn-sm bg-primary mb-3"><i
                                ...
                                @foreach ($peserta->data as $data)
                                    @if ($data->attributes->role == 'Peserta')
                                        <tr>
                                            ...
                                            <td><a
                                                    href="dataPeserta/getPesertaById/{{ Crypt::encryptString($data->id) }}"><button
...
@section('script')
    ...
    <script>
        ...
        $('#delModal').on('show.bs.modal', function(event) {
            ...
            const url = `{{ url('master/dataPeserta/delete') }}/` + id;
            const modal = $(this);
